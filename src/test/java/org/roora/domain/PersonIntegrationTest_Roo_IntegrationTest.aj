...
privileged aspect PersonIntegrationTest_Roo_IntegrationTest {
    ...
    public void PersonIntegrationTest.testCountPeople() {
        ...
        long count = org.roora.domain.Person.countPeople();
    ...
    public void PersonIntegrationTest.testFindPerson() {
        org.roora.domain.Person obj = dod.getRandomPerson();
        ...
        obj = org.roora.domain.Person.findPerson(id);
    ...
    public void PersonIntegrationTest.testFindAllPeople() {
        ...
        java.util.List<org.roora.domain.Person> result = org.roora.domain.Person.findAllPeople();
    ...
    public void PersonIntegrationTest.testFindPersonEntries() {
        ...
        java.util.List<org.roora.domain.Person> result = org.roora.domain.Person.findPersonEntries(0, (int) count);
    ...
    public void PersonIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyPerson(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.roora.domain.Person merged = (org.roora.domain.Person) obj.merge();
        obj.flush();
    ...
    public void PersonIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Person' failed to initialize correctly", dod.getRandomPerson());
        org.roora.domain.Person obj = dod.getNewTransientPerson(Integer.MAX_VALUE);
    ...
    public void PersonIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Person' with identifier '" + id + "'", org.roora.domain.Person.findPerson(id));
    }
